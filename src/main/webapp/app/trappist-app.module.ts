...
import { TrappistAccountModule } from './account/account.module';
import { TrappistEntityModule } from './entities/entity.module';
...
export class TrappistAppModule {}
